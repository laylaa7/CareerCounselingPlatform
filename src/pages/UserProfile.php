    ...
    <div class="info-content edit-mode">
        <div class="grid-container">
            <div class="coolinput">
                ...
                <input type="text" id="degree" name="degree" placeholder="Write here..." class="input">
            </div>
            <div class="coolinput">
                <label for="major" class="text">Major:</label>
                <input type="text" id="major" name="major" placeholder="Write here..." class="input">
            </div>
            <div class="coolinput">
                <label for="university" class="text">University:</label>
                <input type="text" id="university" name="university" placeholder="Write here..." class="input">
            </div>
            <div class="coolinput">
                <label for="graduationYear" class="text">Graduation Year:</label>
