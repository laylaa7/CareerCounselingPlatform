...
<div class="box box-primary">
  ...
  <form role="form" action="<?php echo WEB_ROOT; ?>api/process.php?cmd=book" method="post">
    <div class="box-body">
	  ...
	  <div class="form-group">
        <label for="exampleInputPassword1">Name of Student</label>
		<span id="sprytf_ucount">
        <input type="text" name="NameOfStudent" class="form-control input-sm" placeholder="Name of Student" >
		<span class="textfieldRequiredMsg">Name of Student is required.</span>
...
var sprytf_ucount 	= new Spry.Widget.ValidationTextField("sprytf_ucount");
//-->
</script>
